...
const Maps = () => {
    ...
    return (
        ...
        mapStyle="mapbox://styles/mapbox/streets-v9">
            ...
            <Popup latitude={viewport.latitude} longitude={viewport.longitude} closeButton={true} closeOnClick={false} onClose={() => setShowPopup(false)} anchor="bottom" >
               <img style={{width: '200px', height: '100px'}}src="https://lh3.googleusercontent.com/p/AF1QipOTRqYjLgGUPd_IdTDQXpCeCz7XEFGemb8HNegN=s1360-w1360-h1020"/>
